...
func main() {
	...
	evaluationManager := evaluation.NewManager(logger.Named("EvaluationManager"), esutilClient, policyManager, policyGroupManager, policyAssignmentManager, grafeasExtensions, opaClient, resourceManager, indexManager, filterer)
