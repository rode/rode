...
type ListResourceInstanceOccurrencesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListResourceInstanceOccurrencesRequest) Reset() {
	*x = ListResourceInstanceOccurrencesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListResourceInstanceOccurrencesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListResourceInstanceOccurrencesRequest) ProtoMessage() {}

func (x *ListResourceInstanceOccurrencesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_v1alpha1_rode_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListResourceInstanceOccurrencesRequest.ProtoReflect.Descriptor instead.
func (*ListResourceInstanceOccurrencesRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1alpha1_rode_proto_rawDescGZIP(), []int{7}
}

func (x *ListResourceInstanceOccurrencesRequest) GetResourceUri() string {
	if x != nil {
...
func (x *ListResourceInstanceOccurrencesRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListResourceInstanceOccurrencesRequest) GetPageToken() string {
	if x != nil {
		return x.PageToken
	}
	return ""
...
type ListResourceInstanceOccurrencesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListResourceInstanceOccurrencesResponse) Reset() {
	*x = ListResourceInstanceOccurrencesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListResourceInstanceOccurrencesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListResourceInstanceOccurrencesResponse) ProtoMessage() {}

func (x *ListResourceInstanceOccurrencesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_v1alpha1_rode_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListResourceInstanceOccurrencesResponse.ProtoReflect.Descriptor instead.
func (*ListResourceInstanceOccurrencesResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1alpha1_rode_proto_rawDescGZIP(), []int{8}
}

func (x *ListResourceInstanceOccurrencesResponse) GetOccurrences() []*grafeas_go_proto.Occurrence {
	if x != nil {
		return x.Occurrences
	}
	return nil
...
func (x *ListResourceInstanceOccurrencesResponse) GetNextPageToken() string {
	if x != nil {
		return x.NextPageToken
	}
	return ""
...
var file_proto_v1alpha1_rode_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x87, 0x01, 0x0a, 0x26, 0x4c, 0x69, 0x73, 0x74, 0x52,
	...
	0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x22, 0x90, 0x01, 0x0a, 0x27, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x4f, 0x63, 0x63, 0x75, 0x72, 0x72, 0x65,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x32, 0x8c, 0x0d, 0x0a, 0x04, 0x52, 0x6f,
	...
	0x12, 0x94, 0x01, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x2a, 0x2e, 0x72, 0x6f, 0x64, 0x65,
	...
	0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x2d, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0xd4, 0x01, 0x0a, 0x1f, 0x4c, 0x69, 0x73, 0x74,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	0x4f, 0x63, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x35, 0x2e, 0x72, 0x6f,
	...
	,
	...
	0x61, 0x74, 0x65, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x6f, 0x64, 0x65, 0x2f, 0x72, 0x6f, 0x64, 0x65,
...
var file_proto_v1alpha1_rode_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_v1alpha1_rode_proto_goTypes = []interface{}{
	...
	(*ListResourceInstanceOccurrencesRequest)(nil),  // 7: rode.v1alpha1.ListResourceInstanceOccurrencesRequest
	(*ListResourceInstanceOccurrencesResponse)(nil), // 8: rode.v1alpha1.ListResourceInstanceOccurrencesResponse
	(*UpdateOccurrenceRequest)(nil),                 // 9: rode.v1alpha1.UpdateOccurrenceRequest
	(*grafeas_go_proto.Occurrence)(nil),             // 10: grafeas.v1beta1.Occurrence
	(*grafeas_go_proto.Resource)(nil),               // 11: grafeas.v1beta1.Resource
	(*field_mask.FieldMask)(nil),                    // 12: google.protobuf.FieldMask
	(*EvaluatePolicyRequest)(nil),                   // 13: rode.v1alpha1.EvaluatePolicyRequest
	(*PolicyEntity)(nil),                            // 14: rode.v1alpha1.PolicyEntity
	(*GetPolicyRequest)(nil),                        // 15: rode.v1alpha1.GetPolicyRequest
	(*DeletePolicyRequest)(nil),                     // 16: rode.v1alpha1.DeletePolicyRequest
	(*ListPoliciesRequest)(nil),                     // 17: rode.v1alpha1.ListPoliciesRequest
	(*ValidatePolicyRequest)(nil),                   // 18: rode.v1alpha1.ValidatePolicyRequest
	(*UpdatePolicyRequest)(nil),                     // 19: rode.v1alpha1.UpdatePolicyRequest
	(*EvaluatePolicyResponse)(nil),                  // 20: rode.v1alpha1.EvaluatePolicyResponse
	(*Policy)(nil),                                  // 21: rode.v1alpha1.Policy
	(*empty.Empty)(nil),                             // 22: google.protobuf.Empty
	(*ListPoliciesResponse)(nil),                    // 23: rode.v1alpha1.ListPoliciesResponse
	(*ValidatePolicyResponse)(nil),                  // 24: rode.v1alpha1.ValidatePolicyResponse
}
var file_proto_v1alpha1_rode_proto_depIdxs = []int32{
	10, // 0: rode.v1alpha1.BatchCreateOccurrencesRequest.occurrences:type_name -> grafeas.v1beta1.Occurrence
	10, // 1: rode.v1alpha1.BatchCreateOccurrencesResponse.occurrences:type_name -> grafeas.v1beta1.Occurrence
	11, // 2: rode.v1alpha1.ListResourcesResponse.resources:type_name -> grafeas.v1beta1.Resource
	0,  // 3: rode.v1alpha1.ListGenericResourcesResponse.generic_resources:type_name -> rode.v1alpha1.GenericResource
	10, // 4: rode.v1alpha1.ListResourceInstanceOccurrencesResponse.occurrences:type_name -> grafeas.v1beta1.Occurrence
	10, // 5: rode.v1alpha1.UpdateOccurrenceRequest.occurrence:type_name -> grafeas.v1beta1.Occurrence
	12, // 6: rode.v1alpha1.UpdateOccurrenceRequest.update_mask:type_name -> google.protobuf.FieldMask
	1,  // 7: rode.v1alpha1.Rode.BatchCreateOccurrences:input_type -> rode.v1alpha1.BatchCreateOccurrencesRequest
	13, // 8: rode.v1alpha1.Rode.EvaluatePolicy:input_type -> rode.v1alpha1.EvaluatePolicyRequest
	3,  // 9: rode.v1alpha1.Rode.ListResources:input_type -> rode.v1alpha1.ListResourcesRequest
	5,  // 10: rode.v1alpha1.Rode.ListGenericResources:input_type -> rode.v1alpha1.ListGenericResourcesRequest
	7,  // 11: rode.v1alpha1.Rode.ListResourceInstanceOccurrences:input_type -> rode.v1alpha1.ListResourceInstanceOccurrencesRequest
	9,  // 12: rode.v1alpha1.Rode.UpdateOccurrence:input_type -> rode.v1alpha1.UpdateOccurrenceRequest
	14, // 13: rode.v1alpha1.Rode.CreatePolicy:input_type -> rode.v1alpha1.PolicyEntity
	15, // 14: rode.v1alpha1.Rode.GetPolicy:input_type -> rode.v1alpha1.GetPolicyRequest
	16, // 15: rode.v1alpha1.Rode.DeletePolicy:input_type -> rode.v1alpha1.DeletePolicyRequest
	17, // 16: rode.v1alpha1.Rode.ListPolicies:input_type -> rode.v1alpha1.ListPoliciesRequest
	18, // 17: rode.v1alpha1.Rode.ValidatePolicy:input_type -> rode.v1alpha1.ValidatePolicyRequest
	19, // 18: rode.v1alpha1.Rode.UpdatePolicy:input_type -> rode.v1alpha1.UpdatePolicyRequest
	2,  // 19: rode.v1alpha1.Rode.BatchCreateOccurrences:output_type -> rode.v1alpha1.BatchCreateOccurrencesResponse
	20, // 20: rode.v1alpha1.Rode.EvaluatePolicy:output_type -> rode.v1alpha1.EvaluatePolicyResponse
	4,  // 21: rode.v1alpha1.Rode.ListResources:output_type -> rode.v1alpha1.ListResourcesResponse
	6,  // 22: rode.v1alpha1.Rode.ListGenericResources:output_type -> rode.v1alpha1.ListGenericResourcesResponse
	8,  // 23: rode.v1alpha1.Rode.ListResourceInstanceOccurrences:output_type -> rode.v1alpha1.ListResourceInstanceOccurrencesResponse
	10, // 24: rode.v1alpha1.Rode.UpdateOccurrence:output_type -> grafeas.v1beta1.Occurrence
	21, // 25: rode.v1alpha1.Rode.CreatePolicy:output_type -> rode.v1alpha1.Policy
	21, // 26: rode.v1alpha1.Rode.GetPolicy:output_type -> rode.v1alpha1.Policy
	22, // 27: rode.v1alpha1.Rode.DeletePolicy:output_type -> google.protobuf.Empty
	23, // 28: rode.v1alpha1.Rode.ListPolicies:output_type -> rode.v1alpha1.ListPoliciesResponse
	24, // 29: rode.v1alpha1.Rode.ValidatePolicy:output_type -> rode.v1alpha1.ValidatePolicyResponse
	21, // 30: rode.v1alpha1.Rode.UpdatePolicy:output_type -> rode.v1alpha1.Policy
...
func file_proto_v1alpha1_rode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_v1alpha1_rode_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListResourceInstanceOccurrencesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_v1alpha1_rode_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListResourceInstanceOccurrencesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
