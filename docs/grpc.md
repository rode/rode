...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [string](#string) |  | Unique autogenerated id |
| name | [string](#string) |  | The name of the policy |
| description | [string](#string) |  | A brief description of the policy |
| current_version | [int32](#int32) |  | The current policy version -- not necessarily the newest. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| version | [int32](#int32) |  | The numeric version of the policy. |
| message | [string](#string) |  | A message indicating what was changed in this version |
...
| created | [google.protobuf.Timestamp](#google.protobuf.Timestamp) |  | When this version was created |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [string](#string) |  | the auto-generated id of the policy |
| policy | [Policy](#rode.v1alpha1.Policy) |  |  |
