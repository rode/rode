...
cd /rode-api
protoc -I . -I ./protodeps/grafeas -I ./protodeps/googleapis --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative --doc_out=docs --doc_opt=markdown,grpc.md ./proto/v1alpha1/rode.proto
